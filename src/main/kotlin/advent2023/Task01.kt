...
object Task01 : Task {
    ...
    override fun partB(): Int = parseInput().sumOf { line ->
        ...
        val firstCoord = if(line.substringBefore(firstWordNumber).contains(firstNumber.toString())) firstNumber else firstWord
        val lastCoord = if(line.substringAfterLast(lastWordNumber).contains(lastNumber.toString())) lastNumber else lastWord
